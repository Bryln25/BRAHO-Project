                        ...
                        if (usuarioLog.IdUsuario != usuario.IdUsuario) // valida que haya fila seleccionada
                        {
                            ...
                            "Confirmar Eliminación", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                            {
                                ...
                                if (resultado > 0)
                                {
                                    ...
                                    string detalle = $"{usuarioLog.Nombre}, eliminó el usuario {usuario.Usuarioo} con el nombre de: {usuario.Nombre}";
                                    AuditoriaDAL auditoria = new AuditoriaDAL(usuarioLog);
