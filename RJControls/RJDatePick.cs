...
namespace BRAHO_Project.RJControls
{
    ...
    public class RJDatePick : DateTimePicker
    {
        [ToolboxItem(true)]
        //Fields
        //-> Appearance
        ...
        private Image calendarIcon = Properties.Resources.calendario2;
        private RectangleF iconButtonArea;
        private const int calendarIconWidth = 34;
        private const int arrowIconWidth = 10;
        ...
        public Color SkinColor
        {
            ...
            set
            {
                ...
                if (skinColor.GetBrightness() >= 0.8F)
                    calendarIcon = Properties.Resources.calendario2;
                else calendarIcon = Properties.Resources.calendario2;
                this.Invalidate();
            }
        }
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            using (StringFormat textFormat = new StringFormat())
            {
                ...
                //Draw icon
                graphics.DrawImage(calendarIcon, this.Width - calendarIcon.Width - 20, (this.Height - calendarIcon.Height) / 5);
