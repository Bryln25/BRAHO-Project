...
namespace BRAHO_Project
{
    ...
    public partial class FrmIniciado : Form
    {
        ...
        public FrmIniciado(Usuario usuarioLogueado)
        {
            InitializeComponent();
                ...
                switch (dgvObrasIniciadas.Columns[e.ColumnIndex].Name)
                {
                    case "Ver":
                        if (dgvObrasIniciadas.CurrentRow != null) // valida que haya fila seleccionada
                        {
                            ...
                            FrmVerObra frm = new FrmVerObra(obra, dgvObrasIniciadas);
                            frm.ShowDialog();
                            MostrarObras();
                        }
                        else
                    ...
                    case "Editar":
                        if (dgvObrasIniciadas.CurrentRow != null) // valida que haya fila seleccionada
                        {
                            ...
                            FrmEditarObra frm = new FrmEditarObra(obra, dgvObrasIniciadas, usuario);
                            frm.ShowDialog();
                    ...
                    case "Eliminar":
                            ...
                            "Confirmar Eliminación", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                        {
                            ...
                            if (resultado > 0)
                            {
                                ...
                                string detalle = $"El usuario {usuario.Nombre}, eliminó la obra iniciada: {obra.NombreObra}";
